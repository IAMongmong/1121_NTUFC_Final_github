const checkIcon = (
  <svg width="15" height="15" viewBox="0 0 8 6" className="fill-current">
...
const crossIcon = (
  <svg width="15" height="15" viewBox="0 0 8 8" className="fill-current">
...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="mr-3 flex h-[24px] w-full max-w-[24px] items-center justify-center rounded-full bg-primary bg-opacity-10 text-primary">
        {status === "active" ? checkIcon : crossIcon}
      </span>
      <p className="m-0 text-white font-large text-body-color">{text}</p>
    </div>
  );
};
