...
const featuresData: Feature[] = [
  {
    ...
    title: "Automated Bot",
    paragraph:
      "Unlike other platforms only start trading when you tell them to, our bot is designed to automatically start trading when the price decouples on UniswapV2 and Sushiswap.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Flashloan",
    paragraph:
      "Unlike other flashloan platform that needs to pay 1~5% fee, Fortune Bricker won't ask for fee! We subscribe to every token pair like a normal user, only get rewards when arbitrage is successful.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Upload your arbitrage strategy",
    paragraph:
      "If you share a successful arbitrage strategy with us, we will return 30% of the subscription fees paid by users for your strategy back to you.",
  },
];
